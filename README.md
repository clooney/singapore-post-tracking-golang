# Singapore Post Tracking API For Golang
Singapore Post Tracking API and webhook make it easy to integrate Singapore Post Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a Singapore Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Singapore Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Singapore Post Tracking API](https://www.trackingmore.com/singapore-post-tracking.html)  to:

   *   Get Singapore Post realtime tracking info of muti-carriers in one integration
   *   Provide Singapore Post shipment tracking experience like Amazon
   *   Push Singapore Post notifications of package update with webhook
   *   Verify Singapore Post delivery exception before it is too late
